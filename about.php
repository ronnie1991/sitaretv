	...
	<section class="section section--grid">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-12">
					<h2 class="section__title"><b>Sitare</b> – Best Place for Movies</h2>
				</div>
				<!-- end section title -->

				<!-- section text -->
				<div class="col-12">
					<p class="section__text">It's time to switch to <a href="#">Sitare</a>, Watch web series,Tv serials,movies,short films,news,music videos,reality shows,live tv and many more. Sitare is also a great platform for the newcomers. Watch sitare tv and get the chance to win existing gifts everyhour.</p>
