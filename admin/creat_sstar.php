            ...
            <div class="boxed">
                ...
                <?php include_once("profile-header.php"); ?>
                    <header class="pageheader">
                        <h3><i class="fa fa-film"></i> Sitare Star </h3>
                            ...
                            <div class="col-sm-12 eq-box-sm">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            ...
                                            <h3 class="panel-title"><?= isset($msg)? $msg:'Create Sitare Star';?></h3>
                                        </div>
                                        <!--Block Styled Form -->
                                        <!--===================================================-->
                                        ...
                                        <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name" class="form-control" placeholder="Name of the Star"  REQUIRED />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Best Films*</label>
                                                            <input type="text" name="bestfilms" class="form-control" placeholder="List of Top Films"  REQUIRED />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Cover Pic* (Width 270 pixel / heigh 400 pixel) </label>
                                                            <input type="file" name="coverpic" class="form-control" REQUIRED />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea  name="descripion" placeholder="Write Description" rows="4" class="form-control autosize" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>                                                
                                            ...
                                            <div class="panel-footer text-right">
                                                <button class="btn btn-info" type="submit" name="crtsitarestar">Submit</button>
                                            </div>
                                        </form>
                                        <!--===================================================-->
