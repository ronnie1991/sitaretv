    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <div class="boxed">
                ...
                $bannerDtls=$object->singelBannerDtls(base64_decode($_GET['bnr']));
                ?>
                    <header class="pageheader">
                        <h3><i class="fa fa-pencil-square-o"></i> Update Banner </h3>
                    ...
                    <?php
                    	if(isset($_POST['updateslider']))
                        {
                            ...
                            $msg=$object->updateBannerSlider(base64_decode($_GET['bnr']));
                            }                					
                        }
                            else
                            {
                            ...
                            <div class="col-lg-12">                                
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title"><?= isset($msg)? $msg:'Update Banner Slider';?></h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" /> 
                                            ...
                                            <img src="../img/slider/<?=$bannerDtls['banner_slider'];?>" width="120" height="90">
                                            </div>
                                            <br>
                                            <div class="fallback">
                                            ...
                                            <br>
                                            <div>
                                                <button class="btn btn-info" type="submit" name="updateslider">Update</button>
                                            </div>
                                        </form>
                                        <!--===================================================-->
                                        <!-- End Dropzonejs -->
